...
class MyBot(BaseBot):
    ...
    def __init__(self):
        ...
        self.room_dictionary = {
            "room_1": "65b0c62e2ba06c8f8a095355",
            "room_2": "<insert here your room id>",
        }
        self.developer_usernames = ["Atekinz", "mehmetsme3148" "", ""]
        self.allowed_usernames = ["Atekinz", "mehmetsme3148", "", ""]  # Add more usernames to this list if needed
    ...
    async def on_start(self, session_metadata: SessionMetadata) -> None:
        try:
            ...
            await self.highrise.chat("Hey, beni @Atekinz gönderdi!")
            self.highrise.tg.create_task(self.highrise.teleport(session_metadata.user_id, Position(10, 1, 10, "FrontRight")))
    ...
    async def on_user_join(self, user: User, position: Position | AnchorPosition) -> None:
        try:
            ...
            entry_message = [
                f"{user.username} Hoşgeldin sevimli veled "     
            ]
    ...
    async def on_user_leave(self, user: User) -> None:
        ...
        await self.highrise.chat(f"{user.username} Görüşürüz çirkin")
    ...
    async def on_message(self, user_id: str, conversation_id: str, is_new_conversation: bool) -> None:
        ...
        elif message == "seni seviyorum":
                await self.highrise.send_message(conversation_id, "Ben de seni seviyorum bebek💋")
